...
<footer>
  <div class="fbrand">
    ...
    <div><b>BAMsey</b> — the Observatory's sentinel. Every 60 seconds he re-reads the public BAM API, recomputes concentration, and flags a structural rollover the moment its precursor appears. ${fmt(M.window.snapshots)} snapshots so far, every one of them published, no paywall.</div>
  </div>
